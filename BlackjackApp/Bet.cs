   ...
   public class Bet
    {
        ...
        public void CreateDeck()
        {
            ...
            DeckOfCards.Push(new RegularCard { Regular = Regular.Two, Suit = Suit.Hearts, ID = 3 });
            ...
            DeckOfCards.Push(new RegularCard { Regular = Regular.Three, Suit = Suit.Hearts, ID = 7 });
            ...
            DeckOfCards.Push(new RegularCard { Regular = Regular.Four, Suit = Suit.Hearts, ID = 11 });
            ...
            DeckOfCards.Push(new RegularCard { Regular = Regular.Five, Suit = Suit.Hearts, ID = 15 });
            ...
            DeckOfCards.Push(new RegularCard { Regular = Regular.Six, Suit = Suit.Hearts, ID = 19 });
            ...
            DeckOfCards.Push(new RegularCard { Regular = Regular.Seven, Suit = Suit.Hearts, ID = 23 });
            ...
            DeckOfCards.Push(new RegularCard { Regular = Regular.Eight, Suit = Suit.Hearts, ID = 27 });
            ...
            DeckOfCards.Push(new RegularCard { Regular = Regular.Nine, Suit = Suit.Hearts, ID = 31 });
            ...
            DeckOfCards.Push(new FaceCard { Face = Face.Queen, Suit = Suit.Hearts, ID = 35 });
            ...
            DeckOfCards.Push(new FaceCard { Face = Face.King, Suit = Suit.Hearts, ID = 39 });
            ...
            DeckOfCards.Push(new FaceCard { Face = Face.Jack, Suit = Suit.Hearts, ID = 43 });
            DeckOfCards.Push(new FaceCard { Face = Face.Jack, Suit = Suit.Spades, ID = 44 });

            DeckOfCards.Push(new FaceCard { Face = Face.Ace, Suit = Suit.Clubs, ID = 45 });
            DeckOfCards.Push(new FaceCard { Face = Face.Ace, Suit = Suit.Diamond, ID = 46 });
            DeckOfCards.Push(new FaceCard { Face = Face.Ace, Suit = Suit.Hearts, ID = 47 });
            DeckOfCards.Push(new FaceCard { Face = Face.Ace, Suit = Suit.Spades, ID = 48 });

            DeckOfCards.Push(new FaceCard { Face = Face.Ace, Suit = Suit.Clubs, ID = 49 });
            DeckOfCards.Push(new FaceCard { Face = Face.Ace, Suit = Suit.Diamond, ID = 50 });
            DeckOfCards.Push(new FaceCard { Face = Face.Ace, Suit = Suit.Hearts, ID = 51 });
            DeckOfCards.Push(new FaceCard { Face = Face.Ace, Suit = Suit.Spades, ID = 52 });
        }
